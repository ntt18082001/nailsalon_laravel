   ...
   <header id="header" class="header white-menu navbar-dark">
    <div class="header-wrapper">
        ...
        <div class="wsmobileheader clearfix">
            <span class="smllogo"><img src="{{ asset('client/images/logo-01.png') }}"
                    alt="mobile-logo" /></span>
            <a id="wsnavtoggle" class="wsanimated-arrow"><span></span></a>
            <a href="tel:<x-web-config displayData='brand_phone'/>" class="callusbtn ico-20"><span class="flaticon-phone-call-1"></span></a>
        </div>
                    ...
                    <ul class="wsmenu-list">
                        ...
                        <li aria-haspopup="true" class="wscenterlogo">
                            ...
                            <a href="/" class="logo-white"><img
                                    src="storage/webconfig/<x-web-config displayData='logo' />"
                                    alt="header-logo" /></a>
                        </li>
